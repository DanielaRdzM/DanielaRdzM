...
<div align="justify">
Soy <strong><em>Desarrolladora Backend Jr</em></strong> con un año de experiencia en la creación de <strong>microservicios</strong> en ***Java*** y ***APIs REST*** utilizando los frameworks ***Spring Boot y Maven***,  
